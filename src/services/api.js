...
export const sendTestMedReminderEmail = (payload) =>
  client.post("/reminders/medications/send_test_email", payload);
export const triggerPeriodPredictionEmails = () =>
  client.post("/reminders/medications/send_period_prediction_emails");
